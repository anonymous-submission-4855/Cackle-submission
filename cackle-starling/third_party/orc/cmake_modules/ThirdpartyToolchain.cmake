...
if (NOT "${SNAPPY_HOME}" STREQUAL "")
  ...
  set(SNAPPY_CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${SNAPPY_HOME} -DCMAKE_INSTALL_LIBDIR=lib
...
if (NOT "${ZLIB_HOME}" STREQUAL "")
  ...
  set(ZLIB_CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${ZLIB_PREFIX} -DCMAKE_INSTALL_LIBDIR=lib
                      -DBUILD_SHARED_LIBS=OFF)
...
if (NOT "${ZSTD_HOME}" STREQUAL "")
  ...
  set(ZSTD_CMAKE_ARGS -DCMAKE_INSTALL_PREFIX=${ZSTD_HOME} -DCMAKE_INSTALL_LIBDIR=lib
          -DBUILD_SHARED_LIBS=OFF)
  ...
  if(ORC_CXX_HAS_THREAD_LOCAL)
    ...
    if (CYRUS_SASL_SHARED_LIB AND OPENSSL_LIBRARIES)
      ...
      set (LIBHDFSPP_CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE}
                                -DCMAKE_INSTALL_PREFIX=${LIBHDFSPP_PREFIX} -DCMAKE_INSTALL_LIBDIR=lib
